...
void GS_Main(point EMPTY_INPUT p[1], uint primID : SV_PrimitiveID, inout TriangleStream<POSCOLOR_INPUT> triStream)
{
	...
	// RGB and depth are same resolution so don't need to do height-y
    ...
    */
    ...
    float4 worldPos = float4(worldPosRos.x, -worldPosRos.y, worldPosRos.z, 1.0);
